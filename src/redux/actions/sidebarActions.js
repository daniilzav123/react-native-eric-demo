...
export const showSideBar = showValue => dispatch =>
	dispatch(showSideBar$(showValue));

export const DISABLE_SIDEBAR = "DISABLE_SIDEBAR";
const disableSideBar$ = createAction(DISABLE_SIDEBAR);
export const disableSideBar = disableValue => dispatch =>
	dispatch(disableSideBar$(disableValue));
